...
* Add tests. (this was done via hackdays and no tests were created in effort to get this out the door asap)
...
* Add the ability to grant an entire tier/rank at a time 
* Add the ability to get a list of all grants and see who they were for, when and why
* Move this off heroku
